 ...
 * @author PC
 */
public class BILLS2 extends javax.swing.JFrame {

    /**
     * Creates new form BILLS2
     */
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Distributor Name", "Product", "Quantity", "Rate", "Total"
            }
        ) {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        EnterpriseSoftware.View(jTable1);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BILLS2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
